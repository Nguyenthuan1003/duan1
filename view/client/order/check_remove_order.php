        ...
        <div style="width:50%" class="row shadow-lg p-5 mb-5 m-auto bg-body rounded">
            ...
            <div style="font-size:13px" class="col-md-12 mt-0 w-100">
                ...
                <section class="mt-3  rounded-3">
                    <form action="index.php?act=remove_order" method="post">
                        <div class="input_login">
                            <p class="text-primary text-start">Vui Lòng Nhập Mã xác nhận</p>
                            <input type="text" class="form-control" name="code_check_remove_order">
                        </div>
                        <input type="hidden" value="<?= $id_order ?>" name="remove_id_order">
                        <input type="submit" value="Tiếp Tục" class="btn btn-secondary mt-4 w-100" name="submit_check_remove_order">
                    </form>
                </section>
